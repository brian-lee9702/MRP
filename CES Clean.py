...
ces2011 = pd.read_csv("CES2011.csv", encoding='latin_1')
...
trim15 = ['ID', 'sex_r', 'province', 'phonelocation', 'language', 'lklytovote', 'vote_for', 'vote_lean', 'vote_for_if', 'voted_for',
          'vote_lean', 'vote_for_if', 'voted_for', 'education', 'religion', 'age', 'emp_status', 'ethnic', 'income_full']

trim11 = ['RGENDER11', 'PROVINCE11', 'FED_NAME_11', 'PES11_6', 'CPS11_11', 'CPS11_12', 'CPS11_13' ]

data19 = ces2019[trim19]
data15 = ces2015[trim15]
data11 = ces2011[trim11]



############################################2019 DATA CLEANING ####################################################
ptrim19 = ['cps19_yob', 'cps19_gender', 'cps19_votechoice',
          'cps19_vote_unlikely', 'cps19_v_advance', 'cps19_vote_lean', 'constituencynumber', 'constituencyname']
...
vote_trimmed19 = pdata19[['cps19_yob', 'cps19_gender', 'constituencynumber', 'constituencyname']]
...
CES19_data = CES19_data[['cps19_yob', 'cps19_gender', 'constituencynumber', 'Summed Vote']]
...
CES19_data.columns = ['age', 'gender', 'district', 'vote']

CES19_data.to_csv('CES2019 MRP Frame (Nontemporal).csv')
